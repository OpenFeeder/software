function OF_events_to_subtitles(binFile, subtitlesFile, outputFile, videoBeginTime, videoEndTime, subtitleMaxDuration, separator)
...
%
%   OF_events_to_subtitles(___, ___, ___, ___, VIDEOENDTIME) uses VIDEOENDTIME
%   to synchronize the end time of the subtitles. VIDEOENDTIME is a Nx3
%   numercial array that contains time in the form [HH MM SS]. It
%   can be passed as an empty array if no synchronization needed.
%
%   OF_events_to_subtitles(___, ___, ___, ___, ___, SUBTMAXDURATION) set
%   the maximal visibility time of each subtitle. SUBTMAXDURATION is a
%   scalar and is expressed in seconds.
%
%   OF_events_to_subtitles(___, ___, ___, ___, ___, ___, SEPARATOR) uses
%   SEPARATOR as a string separator in case of multiple events at the same
%   time. If ommitted, SEPARATOR is set to ','.
%
