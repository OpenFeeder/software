...
uiButtonInitLEDs = uicontrol(fig, ...
    'units', 'pixels', ...
    'position', [55 90 button_size_2]*uiSketchfactor, ...
    'fontweight', 'bold', ...
    'string', 'Init LEDs', ...
...
uiButtonTestLEDs = uicontrol(fig, ...
    'units', 'pixels', ...
    'position', [70 90 button_size_2]*uiSketchfactor, ...
    'fontweight', 'bold', ...
    'string', 'Test LEDs', ...
...
uiButtonTestLEDsOrder = uicontrol(fig, ...
    'units', 'pixels', ...
    'position', [85 90 button_size_2]*uiSketchfactor, ...
    'fontweight', 'bold', ...
    'string', 'LEDs order', ...
...
uicontrol(fig, ...
    'style', 'text', ...
    'units', 'pixels', ...
    'position', [56 81 5 5]*uiSketchfactor, ...
    'string', 'R', ...
...
uiEditLedsRed = uicontrol(fig, ...
    'style', 'edit', ...
    'units', 'pixels', ...
    'position', [58 82 edit_size]*uiSketchfactor, ...
    'fontweight', 'bold', ...
    'string', '0', ...
    'tag', 'uiEditLedsRed', ...
    'enable', 'off');
...
uicontrol(fig, ...
    'style', 'text', ...
    'units', 'pixels', ...
    'position', [64 81 5 5]*uiSketchfactor, ...
    'string', 'G', ...
    'horizontalalignment', 'left', ...
    'fontweight', 'bold');
...
uiEditLedsGreen = uicontrol(fig, ...
    'style', 'edit', ...
    'units', 'pixels', ...
    'position', [66 82 edit_size]*uiSketchfactor, ...
    'fontweight', 'bold', ...
    'string', '0', ...
    'tag', 'uiEditLedsGreen', ...
    'enable', 'off');
...
uicontrol(fig, ...
    'style', 'text', ...
    'units', 'pixels', ...
    'position', [72 81 5 5]*uiSketchfactor, ...
    'string', 'B', ...
    'horizontalalignment', 'left', ...
    'fontweight', 'bold');
...
uiEditLedsBlue = uicontrol(fig, ...
    'style', 'edit', ...
    'units', 'pixels', ...
    'position', [74 82 edit_size]*uiSketchfactor, ...
    'fontweight', 'bold', ...
    'string', '0', ...
    'tag', 'uiEditLedsBlue', ...
    'enable', 'off');
...
uiButtonLEDsRGB = uicontrol(fig, ...
    'units', 'pixels', ...
    'position', [80 82 button_size]*uiSketchfactor, ...
    'fontweight', 'bold', ...
    'string', 'set RGB', ...
    'tag', 'uiButtonLEDsRGB', ...
    'enable', 'off', ...
